<section class="content-header">
	<button data-target="#add_group" data-toggle="modal" class="btn btn-success pull-right"><i class="fa fa-plus"></i> New Sub Group</button>
									...
									<tr>
										...
										<td>
											<div class="btn-group btn-group">
												<a data-group-id="<?php echo $value->id; ?>" data-group-name="<?php echo $value->res_group_name; ?>" data-target="#edit_group" data-toggle="modal" class="btn btn-info btn-flat edit editAction" title="Edit"><i class="fa fa-edit"></i></a>
...
<div class="modal fade" id="add_group" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open('Recipients/add_sub_groups', array('id' => 'form_sample_1')); ?>
...
<div class="modal fade" id="edit_group" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open('Recipients/sub_groups/edit_sub_groups', array('id' => 'form_sample_2')); ?>
			<input type="hidden" name="parent_group_id" id="parent_group_id" value="<?php echo $parent_group_id ?>">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				...
				<div class="text-center">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="wrap-validation">
								<div class="check-val">
									<?php echo form_input('sub_group_name', $this->input->post('sub_group_name'), 'class="form-control edit_name" tabindex=1 required="required" id="sub_group_name" placeholder="Group Name"'); ?>							
								</div>
							</div>
						</div>
					</div>
